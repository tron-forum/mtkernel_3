...
#define	SCB_FPCAR	0xE000EF38
#define SCB_FPDSCR	0xE000EF3C

#define	SCB_CPACR_FPUENABLE	0x00F00000	/* Enable FPU (CP10,CP11) */
#define SCB_FPCCR_ASPEN		0x80000000	/* FPCCR.ASPEN */
#define SCB_FPCCR_LSPEN		0x40000000	/* FPCCR.LSPEN */
